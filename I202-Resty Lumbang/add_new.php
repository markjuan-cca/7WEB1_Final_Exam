...
<html lang="en">
    ...
    <body style="background-color:black;">
        <nav class="navbar bg-secondary justify-content-center fs-3 mb-5" > <span style="color:white;">PHP Complete CRUD Application </span> </nav>
        <div class="container">
            <div class="text-center mb-3">
                <h3 style="color:white;">Add New User</h3>
                <p class="text-muted" style="color:white;">Complete the form below to add a new user</p>
            </div>
