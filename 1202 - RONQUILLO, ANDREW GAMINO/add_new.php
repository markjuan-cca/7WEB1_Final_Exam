...
if (isset($_POST['submit'])) {
    ...
    // Use backticks for table and column names, and ensure the number of columns matches the values
    $sql = "INSERT INTO `CRUD1` (`first_name`, `last_name`, `email`, `gender`, `year`, `section`)
